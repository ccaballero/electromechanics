...
set arrow from 0,-1.25 to 1*pi,-1.25 heads linetype 2 linewidth 2
set label '$T$' at 0.46*pi,-1.6

plot ((-2*pi<=x && x<=-1*pi) ? sin(x) : NaN) linetype 6 linewidth 3 notitle
plot ((-1*pi<=x && x<= 0*pi) ? sin(x) : NaN) linetype 0 linewidth 3 notitle
plot (( 0*pi<=x && x<= 1*pi) ? sin(x) : NaN) linetype 6 linewidth 3 notitle
plot (( 1*pi<=x && x<= 2*pi) ? sin(x) : NaN) linetype 0 linewidth 3 notitle
plot (( 2*pi<=x && x<= 3*pi) ? sin(x) : NaN) linetype 6 linewidth 3 notitle
plot (( 3*pi<=x && x<= 4*pi) ? sin(x) : NaN) linetype 0 linewidth 3 notitle

plot ((-1*pi<=x && x<= 0*pi) ? -sin(x) : NaN) linetype 6 linewidth 3 notitle
plot (( 1*pi<=x && x<= 2*pi) ? -sin(x) : NaN) linetype 6 linewidth 3 notitle
plot (( 3*pi<=x && x<= 4*pi) ? -sin(x) : NaN) linetype 6 linewidth 3 notitle
