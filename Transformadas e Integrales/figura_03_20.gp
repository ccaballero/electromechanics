...
set label '$|c_n|$'     at -1.45, 4.3
set label '$-3\omega_0$'       at -3.9 ,-0.6
set label '$ -\omega_0$'       at -1.6 ,-0.6
set label '$  \omega_0$'       at  0.9 ,-0.6
set label '$ 3\omega_0$'       at  2.6 ,-0.6

set arrow from  0,0 to  0,3.5, graph 1 linetype 7 linewidth 1 nohead
set arrow from  1,0 to  1,2,   graph 1 linetype 7 linewidth 1 nohead
set arrow from -1,0 to -1,2,   graph 1 linetype 7 linewidth 1 nohead
set arrow from  2,0 to  2,1.0, graph 1 linetype 7 linewidth 1 nohead
set arrow from -2,0 to -2,1.0, graph 1 linetype 7 linewidth 1 nohead
set arrow from  3,0 to  3,0.5, graph 1 linetype 7 linewidth 1 nohead
set arrow from -3,0 to -3,0.5, graph 1 linetype 7 linewidth 1 nohead
